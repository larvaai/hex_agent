...
> Sổ quyết định (DEC register) của repo: [../decisions.md](../decisions.md). Tài liệu này là một quyết-định-thiết-kế cụ thể (E07↔E09); mọi DEC số hoá gom về `decisions.md`.
