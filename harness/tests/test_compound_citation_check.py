"""test_compound_citation_check.py — re-verify the citations in an hs-flow:compound proposal.

hs-flow:compound grounds each self-improvement proposal in a citation: a BACKLOG item
