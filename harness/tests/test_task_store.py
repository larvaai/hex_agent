...
class TestErrorTaxonomy:
    def test_all_classes_descend_from_task_store_error(self):
        for cls in (ConfigError, AuthError, NotFound, RateLimited, Unavailable):
            assert issubclass(cls, TaskStoreError)
