...
1. **Screenshots provided** → Use `hs-ai:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `hs-ai:ai-multimodal` video-analysis for comprehensive context
...
6. **Write** → Use `developer` agent to execute plan
