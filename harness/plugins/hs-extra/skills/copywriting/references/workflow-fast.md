...
1. **Screenshots provided** → Use `hs-ai:ai-multimodal` skill to analyze context
2. **Videos provided** → Use `hs-ai:ai-multimodal` video-analysis for context
3. **Write** → Use `developer` agent directly to produce copy
