...
1. **Screenshots provided** → Use `hs-ai:ai-multimodal` skill to analyze conversion issues
2. **Videos provided** → Use `hs-ai:ai-multimodal` video-analysis for bottleneck identification
...
5. **Implement** → Use `developer` agent to write enhanced copy into code files
