...
2. Skill prints: "Daily quota exhausted. Use hs-uiux:ui-ux-pro-max as fallback."
3. Activate `hs-uiux:ui-ux-pro-max` with the same design prompt
...
Local tracking can drift if user generates designs outside SDLC Harness (via Stitch web UI or other tools). If you hit `RATE_LIMITED` error despite local tracker showing credits available:
