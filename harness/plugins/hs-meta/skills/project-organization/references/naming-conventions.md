...
Use `YYMMDD-HHmm` (default). No HARNESS_PLAN_DATE_FORMAT env var exists in the current
repo — get a timestamp with:
...
Pattern: `phase-{NN}-{name}.md` (zero-padded number)

Examples:
- `phase-01-research.md`
- `phase-02-implement-hooks.md`
- `phase-03-tdd-scripts.md`
