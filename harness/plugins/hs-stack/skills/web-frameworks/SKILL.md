...
Quick Start (Next.js / Turborepo / RemixIcon setup), common full-stack & monorepo patterns,
best practices, and the implementation checklist: [`web-frameworks-playbook.md`](./references/web-frameworks-playbook.md).
