...
Quick-reference performance targets, decision matrices, checklists, and platform
guidelines for mobile builds. Companion detail for the core `mobile-development` skill.
