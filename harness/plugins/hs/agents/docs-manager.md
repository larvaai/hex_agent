...
**IMPORTANT**: Analyze available `hs:*` skills and activate those needed for the task.
...
- Use `hs-research:repomix` skill to generate a codebase compaction, then generate/update `docs/codebase-summary.md` from it
...
**Target:** Keep all doc files under 800 LOC by default.
...
2. Use `hs-research:repomix` to generate/update a comprehensive codebase summary and create `docs/codebase-summary.md`
...
- Ensure documentation follows established style guides per `harness/standards/code-standards.md`
...
- Create or update `harness/standards/code-standards.md` with comprehensive codebase structure and code standards
