...
model: opus
tools: Glob, Grep, Read, Edit, MultiEdit, Write, Bash, TaskCreate, TaskGet, TaskUpdate, TaskList, SendMessage, Task
---
...
2. **Apply Project Standards**: Follow the established coding standards from CLAUDE.md, `harness/rules/harness-contract.md`, and `harness/standards/code-standards.md`. Adapt to the project's language, framework, and conventions.
...
6. Run appropriate verification (type/lint checks per project stack, tests) if available
