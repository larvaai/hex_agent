...
Test only **one hypothesis** and **one variable** at a time. Multiple simultaneous changes
mean you cannot tell what caused the result — you must start over.
...
- STOP — ask the user, consider `hs-think:brainstorm` to revisit the design.
