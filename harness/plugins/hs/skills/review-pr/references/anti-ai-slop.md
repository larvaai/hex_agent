...
Concrete taxonomy of slop patterns that LLM-assisted PRs commonly introduce. Load when:
diff >300 lines, >=2 inline flags in SKILL.md are triggered, or the PR creates >2 new files in
`utils/`/`helpers/`.
