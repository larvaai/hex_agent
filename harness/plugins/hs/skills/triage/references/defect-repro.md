...
Flakiness not caused by code logic → record and document, **do not fast-fix** —
...
2. Ask the user via AskUserQuestion:
   ...
   - **Move to BACKLOG** — defect not critical enough to spend more resources now
...
Report → `plans/reports/<slug>-triage-repro-report.md`.
Then continue to triage Step 2 (hs:scout).
