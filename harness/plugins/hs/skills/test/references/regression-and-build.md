...
python3 harness/scripts/preflight_deps.py
...
python3 harness/e2e/run_vertical_slice.py

# Full install verification
python3 harness/scripts/verify_install.py --strict
```

Build warnings do not block but should be recorded in `PASS_WITH_RISK` if they relate
to a dependency or deprecation that affects correctness.
