...
[N] <URL> | <author/org> | <date> | <VERIFIED|UNVERIFIED>

## Open questions
- [UNVERIFIED] <claim> — source needed: <suggested direction>
...
- `[UNVERIFIED]` tag must appear both in the body and in "Open questions".

## File naming

Pattern: `plans/reports/<slug>-research-<YYMMDD>.md`  
Slug = kebab-case from the main topic (<=4 words). Examples:
...
Agent returns: absolute path to the saved file.
Controller does not rewrite the output — only relays the path and a short summary to the user.
