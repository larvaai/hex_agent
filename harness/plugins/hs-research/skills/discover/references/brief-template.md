...
Use this template in step 4 of hs-research:discover. Save to
`plans/<slug>/discovery-brief.md`. Do not create markdown files outside `plans/`
(CI invariant, `harness/rules/documentation-management.md`).
