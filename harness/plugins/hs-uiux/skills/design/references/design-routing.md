...
**Brand:**
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/brand/scripts/inject-brand-context.cjs
node ${CLAUDE_PLUGIN_ROOT}/skills/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/design-system/scripts/generate-tokens.cjs -c tokens.json
node ${CLAUDE_PLUGIN_ROOT}/skills/design-system/scripts/validate-tokens.cjs -d src/
```
