...
Use Chrome headless, `hs-devops:agent-browser`, or Playwright/Puppeteer to capture exact-size screenshots.
...
#### Option B: hs-devops:agent-browser

Invoke `/hs-devops:agent-browser` with instructions to:
