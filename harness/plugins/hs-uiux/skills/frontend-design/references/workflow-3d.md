...
## Prerequisites
- Activate `hs-uiux:ui-ux-pro-max` skill first
- Activate `hs-ai:threejs` skill for 3D and WebGL expertise
- Have `hs-ai:ai-multimodal` skill ready for asset generation

## Initial Research
Run `hs-uiux:ui-ux-pro-max` searches:
```bash
...
Use `hs-ai:ai-multimodal` skill for:
- Textures and materials
- Skyboxes and environment maps
- Particle sprites
- Video backgrounds

Use `hs-ai:media-processing` skill for:
