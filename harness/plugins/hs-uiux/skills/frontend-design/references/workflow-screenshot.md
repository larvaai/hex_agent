...
## Prerequisites
- Activate `hs-uiux:ui-ux-pro-max` skill first for design intelligence
- Have `hs-ai:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `hs-ai:ai-multimodal` skill to extract:
...
### 4. Generate Assets
Use `hs-ai:ai-multimodal` skill:
- Generate images, icons, backgrounds
- Verify generated assets match design
- Remove backgrounds if needed with `hs-ai:media-processing`
