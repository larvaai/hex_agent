...
Test at extreme values (1000x larger/smaller, instant/years) to reveal fundamental truths
hidden at normal scale.

## Core principle

**Extremes reveal the foundation.** Something that works at this scale may break at another.
"Should scale fine" with no evidence = an unverified assumption.
