...
**Find the pattern in how patterns appear.** When the same shape appears in 3+
independent domains, it is a universal principle — extract it and reuse it.
...
- `verification-mechanism.md`: claim -> anchor evidence -> next step rejects UNVERIFIED
