...
Find a single insight that eliminates many components at once.
"If this is true, we no longer need X, Y, or Z."

## Core principle

**Everything is a special case of a general pattern** — recognizing that pattern
collapses accumulated complexity.
