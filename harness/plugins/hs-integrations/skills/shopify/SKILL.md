...
Development workflow (CLI scaffolding, dev/deploy cycle), essential implementation
patterns, and troubleshooting: [`workflow-and-patterns.md`](references/workflow-and-patterns.md).
