...
The 96 skill ``description`` strings are the router contract: the text the
UserPromptSubmit / SessionStart surface and ``hs-meta:find-skills`` / ``hs-research:autoresearch``
