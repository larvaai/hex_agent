"""telemetry_formatters.py — output formatting: markdown tables, JSON, summary
blocks, severity badges.
...
def summary_block(title: str, items: dict) -> str:
...
def severity_badge(severity: str) -> str:
    ...
    return badges.get(severity.upper(), "[%s]" % severity)
