...
Read the configured output language from `harness/data/output.yaml` first: when
`language: vi`, the Vietnamese translation-tell table below is the highest-value
section; when `language: en`, lean on the banned-vocabulary list.
